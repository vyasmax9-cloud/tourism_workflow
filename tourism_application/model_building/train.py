...
Xtrain_path = "hf://datasets/vyasmax9/tourism-predict-app/Xtrain.csv"
Xtest_path = "hf://datasets/vyasmax9/tourism-predict-app/Xtest.csv"
ytrain_path = "hf://datasets/vyasmax9/tourism-predict-app/ytrain.csv"
ytest_path = "hf://datasets/vyasmax9/tourism-predict-app/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_tourism_app_v1.joblib"
    ...
    api.upload_file(
        path_or_fileobj="best_tourism_app_v1.joblib",
        path_in_repo="best_tourism_app_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
